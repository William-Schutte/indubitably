...
with open('indeed2.html', 'r') as html_file:
    ...
    for job in job_blocks:
        ...
        job_location = job.find('div', class_='recJobLoc').attrs['data-rc-loc']
...
# Test to make sure the lists have appropriate elements


print(jobs_master_list[0])
